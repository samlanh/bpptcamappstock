...
public function init()
    ...
    public function indexAction()
    {
		...
		$columns=array("BRANCH_NAME","ITEM_CODE","ITEM_NAME","BARCODE",
				"CATEGORY","MEASURE","QTY","PRODUCT_TYPE","USER","STATUS");
		$link=array(
		...
		$this->view->list=$list->getCheckList(0, $columns, $rows, array('item_name'=>$link,'item_code'=>$link,'barcode'=>$link,
				'branch'=>$link));
