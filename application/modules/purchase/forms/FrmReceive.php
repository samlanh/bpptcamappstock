...
class Purchase_Form_FrmReceive extends Zend_Form
{
    ...
    public function productOrder($data=null)
    {
    	...
    	$purchase_status = new Zend_Form_Element_Hidden('purchase_status');
    	$purchase_status->setAttribs(array('readonly'=>'readonly','style'=>'text-align:left',"class"=>"form-control"));
    	$this->addElement($purchase_status);
    	
    	$receive_status = new Zend_Form_Element_Hidden('receive_status');
    	$receive_status->setAttribs(array('readonly'=>'readonly','style'=>'text-align:left',"class"=>"form-control"));
    	$this->addElement($receive_status);
   ...
   ///conter leave controll 
    	...
    	Application_Form_DateTimePicker::addDateField(array('order_date','date_in','receiv_date'));
    		if($data != null) {
    			...
    			$price_product->setValue($data['sub_total_product']);
    			$price_jobtype->setValue($data['sub_total_jobtype']);
    			$purchase_status->setValue($data['purchase_status']);
    			$receive_status->setValue($data['receive_status']);
